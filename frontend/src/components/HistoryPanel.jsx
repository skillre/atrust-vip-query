			...
			<div className="card">
				...
				<div className="form-row">
					<div className="form-group">
						<label className="form-label" htmlFor="history-name">
							用户名或显示名
						</label>
						<input
							type="text"
					...
					<div className="form-group">
						<label className="form-label" htmlFor="history-days">
							查询天数
						</label>
						<input
							type="number"
					...
					<div className="form-group">
						<label className="form-label" htmlFor="history-page">
							页码
						</label>
						<input
							type="number"
					...
					<div className="form-group">
						<label className="form-label" htmlFor="history-page-size">
							每页条数
						</label>
						<input
							type="number"
							...
							{!result.records || result.records.length === 0 ? (
								...
								<>
									...
									>
										...
										>
											共 {result.total} 条记录 · 第 {result.page} 页 · 每页{" "}
											{result.page_size} 条
										</span>
										<button
